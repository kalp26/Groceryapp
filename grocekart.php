...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <a href="#topseller" class="btn1">Buy Now</a>
        </div>
    ...
    <section class="categories" id="categories">
        ...
        <div class="swiper categories-slider">
            ...
            <div class="swiper-slide box">
                ...
                <h3>Vegetables</h3>
                <p>upto 40% off</p>
                <a href="vegetables.php" class="btn1">Buy Now</a>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <h3>Fruits</h3>
                <p>upto 35% off</p>
                <a href="fruits.php" class="btn1">Buy Now</a>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <h3>Dairy & Bakery</h3>
                <p>upto 15% off</p>
                <a href="dairy.php" class="btn1">Buy Now</a>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <h3>Beverages</h3>
                <p>upto 10% off</p>
                <a href="beverages.php" class="btn1">Buy Now</a>
            </div>
            ...
            <div class="swiper-slide box">
                ...
                <h3>Snacks</h3>
                <p>upto 18% off</p>
                <a href="snacks.php" class="btn1">Buy Now</a>
            </div>
            </div>
        </div>
    </section>
